...
import it.unica.blockchain.blockchains.ethereum.{ERC20Allowance, ERC20Approve, ERC20BalanceOf, ERC20Transaction, ERC20Transfer, ERC20TransferFrom, ERC721Approve, ERC721BalanceOf, ERC721GetApproved, ERC721IsApprovedForAll, ERC721OwnerOf, ERC721SafeTransferFrom, ERC721SafeTransferFromWithBytes, ERC721SetApprovalForAll, ERC721Transaction, ERC721TransferFrom, EthereumSettings}
