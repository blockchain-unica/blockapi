...
/**
  * Factories for [[it.unica.blockchain.blockchains.bitcoin.BitcoinOutput]] instances.
  */
object BitcoinOutput {

  /**
    * Factory for [[it.unica.blockchain.blockchains.bitcoin.BitcoinOutput]] instances.
