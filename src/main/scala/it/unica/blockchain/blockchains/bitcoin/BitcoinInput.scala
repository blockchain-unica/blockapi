...
/**
  * Factories for [[it.unica.blockchain.blockchains.bitcoin.BitcoinInput]] instances.
  */
object BitcoinInput {

  /**
    * Factory for [[it.unica.blockchain.blockchains.bitcoin.BitcoinInput]] instances.
