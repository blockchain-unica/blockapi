...
/**
  * Factories for [[it.unica.blockchain.blockchains.bitcoin.BitcoinBlock]] instances.
  */
object BitcoinBlock {


  /**
    * Factory for [[it.unica.blockchain.blockchains.bitcoin.BitcoinBlock]] instances.
