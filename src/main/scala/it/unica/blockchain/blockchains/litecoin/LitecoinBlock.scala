...
/**
  * Factories for [[it.unica.blockchain.blockchains.litecoin.LitecoinBlock]] instances.
  */
object LitecoinBlock {


  /**
    * Factory for [[it.unica.blockchain.blockchains.litecoin.LitecoinBlock]] instances.
