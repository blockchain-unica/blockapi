package it.unica.blockchain.externaldata.ICOAPIs

import java.security.SecureRandom

import javax.net.ssl.{HttpsURLConnection, SSLContext}
import scalaj.http.Http
import it.unica.blockchain.externaldata.ICOAPIs.ICOBenchAPIs.{Exchanges, ICOBenchAPI}
import it.unica.blockchain.externaldata.ICOAPIs.ICORatingAPIs.ICORatingAPI
import it.unica.blockchain.externaldata.ICOAPIs.coinMarketCapAPIs.CoinMarketCapAPI
import it.unica.blockchain.externaldata.ICOAPIs.etherScanAPIs.EtherScanAPI
import it.unica.blockchain.externaldata.ICOAPIs.ethplorerAPIs.EthplorerAPI
import it.unica.blockchain.externaldata.ICOAPIs.tokenWhoIsAPIs.TokenWhoIsAPI
