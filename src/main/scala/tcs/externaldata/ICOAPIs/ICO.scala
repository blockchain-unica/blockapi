package tcs.externaldata.ICOAPIs

import java.security.SecureRandom

import javax.net.ssl.{HttpsURLConnection, SSLContext}
import scalaj.http.Http
import tcs.externaldata.ICOAPIs.ICOBenchAPIs.{Exchanges, ICOBenchAPI}
import tcs.externaldata.ICOAPIs.ICORatingAPIs.ICORatingAPI
import tcs.externaldata.ICOAPIs.coinMarketCapAPIs.CoinMarketCapAPI
import tcs.externaldata.ICOAPIs.etherScanAPIs.EtherScanAPI
import tcs.externaldata.ICOAPIs.ethplorerAPIs.EthplorerAPI
import tcs.externaldata.ICOAPIs.tokenWhoIsAPIs.TokenWhoIsAPI
