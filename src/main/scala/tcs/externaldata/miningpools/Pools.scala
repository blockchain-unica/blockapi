...
object Pools {
  ...
  val BITCOININDIA = "BitcoinIndia"
  val BITCOINRUSSIA = "BitcoinRussia"
  val BITFURY = "BitFury"
  val BITMINTER = "BitMinter"
  val BTCC = "www.btcc.ren"
  val BTCCOM = "BTC.COM"
  val BTCCPOOL = "BTCCPool"
  val BTCTOP = "BTC.TOP"
  val BW = "BW.COM"
  ...
  val ETHERMINE = "Ethermine"
  val ETHPOOL2 = "Ethpool_2"
