...
public interface LitecoindInterface {
    ...
    String getrawtransaction(String hash, int verbose);
    ...
    String sendtoaddress(String litecoinAddress, BigDecimal amount);
    ...
    AddressInformation validateaddress(String litecoinAddress);
	...
	//Returns a Base64 encoded signature used to verify the provided message was signed by the owner of litecoinaddress
    String signmessage(String litecoinaddress, String message);
	//Verifies the signature and message matches the litecoin address provided (See signmessage)
    boolean verifymessage(String litecoinaddress, String signature, String message);
	//stop
    String stop();
